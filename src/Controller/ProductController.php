...
class ProductController extends AbstractController
{
    ...
    #[Route('/app_reservation/{b}', name: 'app_reservation')]

    public function reservation($b)
    {
        return new Response (content:"nouvelle page".$b);
    }
    
    #[Route('/clubs', name: 'app_club')]

    public function clublist(ClubRepository $repository)
    {
        $clubs=$repository->findAll();
        return $this->render("club/club.html.twig", array("tabClub"=>$clubs));
    }
